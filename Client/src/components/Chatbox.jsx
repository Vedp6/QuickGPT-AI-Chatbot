...
const Chatbox = () => {
  ...
  return (
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
      ...
      {mode === 'image' && (
        <label className='inline-flex items-center justify-center gap-2 mb-3 text-sm max-auto'>
      ...
      {/* Prompt Input box */}
      <form onSubmit={onSubmit} className='bg-primary/20 data:bg-[#583C79]/30 border border-primary dark:border-[#80609F]/30 rounded-full w-full max-w-2xl p-3 pl-4 max-auto flex gap-4 items-center'>
